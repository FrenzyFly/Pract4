...
public class UserListReviewAdapter extends RecyclerView.Adapter<UserListReviewAdapter.ViewHolder> {

    private final List<UserListItem> userList;
    private final LayoutInflater inflater;

    public UserListReviewAdapter(Context context, List<UserListItem> userList) {
